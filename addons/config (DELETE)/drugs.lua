...
drugs.DrugDealerItems = {  -- add any item here to be sold
...
drugs.DealerBlip = false
drugs.LicenseEnable = false -- enable processing licenses? The player will be required to buy a license in order to process drugs. Requires esx_license
...
drugs.GiveBlack = true -- give black money? if disabled it'll give regular cash.
