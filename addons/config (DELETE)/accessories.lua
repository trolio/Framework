...
accessories.Locale = 'en'

accessories.Price = 20

accessories.EnableControls = true

accessories.DrawDistance = 100.0
accessories.Size   = {x = 1.5, y = 1.5, z = 1.0}
accessories.Color  = {r = 102, g = 102, b = 204}
accessories.Type   = 1

-- Fill this if you want to see the blips,
-- If you have esx_clothesshop you should not fill this
-- more than it's already filled.
accessories.ShopsBlips = {
	Ears = {
		Pos = nil,
		Blip = nil
	},
