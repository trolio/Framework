...
holdup.PoliceNumberRequired = 2
holdup.TimerBeforeNewRob    = 1800 -- The cooldown timer on a store after robbery was completed / canceled, in seconds

holdup.MaxDistance    = 20   -- max distance from the robbary, going any longer away from it will to cancel the robbary
holdup.GiveBlackMoney = true -- give black money? If disabled it will give cash instead
