...
communityservice.Locale = 'en'

communityservice.ServiceExtensionOnEscape		= 2


communityservice.ServiceLocation 				= {x =  170.43, y = -990.7, z = 30.09}

communityservice.ReleaseLocation				= {x = 427.33, y = -979.51, z = 30.2}

communityservice.ServiceLocations = {
