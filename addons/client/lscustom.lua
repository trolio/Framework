...
function OpenLSMenu(elems, menuname, menutitle, parent)
	...
	ESX.UI.Menu.Open(
		...
		function(data, menu) -- on validate
			...
			local found = false
			for k,v in pairs(Config.lsCustomMenus) do
		...
		if data.value == k then
			...
			if v.modType ~= nil then
				...
				if data.value == 'primaryRespray' or data.value == 'secondaryRespray' or data.value == 'pearlescentRespray' or data.value == 'modFrontWheelsColor' then
					for i=1, #Config.lsCustomColors, 1 do
						if data.value == 'primaryRespray' then
							table.insert(elements, {label = Config.lsCustomColors[i].label, value = 'color1', color = Config.lsCustomColors[i].value})
						elseif data.value == 'secondaryRespray' then
							table.insert(elements, {label = Config.lsCustomColors[i].label, value = 'color2', color = Config.lsCustomColors[i].value})
						elseif data.value == 'pearlescentRespray' then
							table.insert(elements, {label = Config.lsCustomColors[i].label, value = 'pearlescentColor', color = Config.lsCustomColors[i].value})
						elseif data.value == 'modFrontWheelsColor' then
							table.insert(elements, {label = Config.lsCustomColors[i].label, value = 'wheelColor', color = Config.lsCustomColors[i].value})
						end
					end
				else
