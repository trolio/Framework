...
Citizen.CreateThread(function()
	while true do
		...
		for k,v in pairs(Config.PlasticSurgeryZones) do
			if(v.Type ~= -1 and GetDistanceBetweenCoords(coords, v.Pos.x, v.Pos.y, v.Pos.z, true) < Config.PlasticSurgeryDrawDistance) then
